...
export default function checkout(){
    ...
    <div>
        <Navbar/>
        <div className="container_chechkout w-[1240px] h-[100%] m-auto">
...
<h1>Apt, suite, unit</h1>
            ...
            <div className="container_section_inputs w-[1240px] h-[100%] m-auto">
                <h1>Phone</h1>
            <input type="text" placeholder="phone" className="inputs" />
            </div>
        </div>
            <div className="w-[1240px] h-[100%] m-auto">
