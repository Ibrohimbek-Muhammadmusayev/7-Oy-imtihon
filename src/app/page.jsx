      ...
      <div className="header-element">
        <div className="m-auto max-w-[1448px] h-[716px] ">
          <div className="flex flex-col gap-[40px] pt-[120px] pl-[193px] font-sans text-white">
            ...
            <a href="/products"><button className="text-black transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 hover:text-white duration-300 font-bold w-[250px] h-[61px] bg-white rounded-[8px]">Shop Now</button></a>
          </div>
        </div>
      </div>
      <main className="m-auto w-[1448px] h-[100%]">
        <section>
          {/* middle cards element */}
        ...
        <section className="m-auto max-w-[1240px] h-[100%]">
          ...
          <div className="flex items-center gap-[20px] pt-[30px] justify-between">
            {data.map((item) =>(
              <div key={item.id} className="w-[262px] items-center text-center h-[330px] flex gap-[8px] flex-col">
            ...
            {category.map((item) =>(
              <a href={item.id}>
                <div className="w-[270px] h-[450px] cursor-pointer">
                    <img className="w-[270px] h-[350px]" src={item.image} alt="" />
                    <h1>{item.title }</h1>
          ...
          <div className="flex flex-wrap flex-col items-center pt-[43px] text-white max-w-[1240px] h-[357px] bg-[#3C4242]">
            <h1 className="font-extrabold text-[50px]">Top Brands Deal</h1>
            <h3 className="text-[22px] font-bold pt-[25px]">Up To <span className="text-[#FBD103]">60%</span> off on brands</h3>
            <div className="flex flex-wrap pt-[67px] gap-[25px]">
              <Image
                src="/png/com1-image.png"
                alt="images"
                width={177}
                height={85}
              />
              <Image
                src="/png/com2-image.png"
                alt="images"
                width={177}
                height={85}
              />
              <Image
                src="/png/com3-image.png"
                alt="images"
                width={177}
                height={85}
              />
              <Image
                src="/png/com4-image.png"
                alt="images"
                width={177}
                height={85}
              />
              <Image
                src="/png/com5-image.png"
                alt="images"
                width={177}
                height={85}
              />
          ...
          <div className="pt-[92px] flex items-center gap-[20px]">
            <div className="w-[6px] h-[30px] bg-[#8A33FD] rounded-[10px]"></div>
            <h1 className="font-semibold text-[34px]">Feedback</h1>
          </div>
          <div className="pt-[70px] pb-[136px] flex justify-between">
